...
var apropos = new oApropos("Patrick Cardona", "2012-2019", "Repérage", "3.0.0");

// App ou API courantes :
apropos.ajoute("Repérage de Patrick Cardona", "https://pcardona34.github.io/exercice_reperage/reperage.html", "GPL", "https://github.com/pcardona34/exercice_reperage");

var img = "\nLes smileys utilisés dans l'exerciseur de Repérage proviennent de la collection Tango, galerie OpenClipart.org. \nAuteur : Warszawianka\n";
img += "\nLogos de Repérage : © Patrick Cardona.";
apropos.img = img;
